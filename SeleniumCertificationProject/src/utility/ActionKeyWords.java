...
public class ActionKeyWords {
	...
	public void clearText(String LocVariable) {
		WebElement element = driver.findElement(LocatorSplitFunction.LocatorSplit(LocVariable));
		element.clear();
	}
	...
	public void isDisplayed(String LocVariable) {
		WebElement element = driver.findElement(LocatorSplitFunction.LocatorSplit(LocVariable));
		boolean disElement = element.isDisplayed();
		System.out.println("Is Selenium Displayed in wishlist?" + disElement);	
	}
